...
Check the census table view at your local domain eg. `https://localhost:5173/lang-nav/data?entityType=Census&view=Table` to make sure your new censuses appear and there are roughly as many languages as you expected. Noting that `mis`/`und`/`mul` languages have already been filtered out.
