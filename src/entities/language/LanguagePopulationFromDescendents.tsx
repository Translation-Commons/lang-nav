...
const LanguagePopulationOfDescendents: React.FC<{ lang: LanguageData }> = ({ lang }) => {
...
const PopulationOfDescendentsBreakdown: React.FC<{ lang: LanguageData }> = ({ lang }) => {
  ...
  return (
    <table>
      <caption>Computed by adding up constituent languages/dialects</caption>
      {lang.childLanguages
...
export default LanguagePopulationOfDescendents;
