...
const MacosSupportStatus: React.FC<{ lang: LanguageData }> = ({ lang }) => {
  if (!lang.macos || lang.macos.length === 0) {
    return (
...
export default MacosSupportStatus;
