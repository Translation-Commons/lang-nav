...
const DocsPage: React.FC = () => {
  return (
    <DocsPageContainer title="Documentation Hub">
      ...
      <DocsSection title="Core Pages">
        ...
        <DocsCardGrid>
          <DocsCard title="About LangNav" page={LangNavPageName.About}>
            Learn about the project’s purpose, values, and the kinds of language information LangNav
            aims to make easier to explore.
          </DocsCard>
          ...
          <DocsCard title="Terms of Use" href="/terms-of-use" isDisabled={true}>
      ...
      <DocsSection title="Data & Methodology">
        ...
        <DocsCardGrid>
          ...
          <DocsCard title="Data Sources" href="/data-sources" isDisabled={true}>
