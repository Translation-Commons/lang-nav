...
const LanguagesMissingWritingSystems: React.FC = () => {
    ...
    return (
        <CollapsibleReport title={`Languages missing writing systems (${languagesFiltered.length})`}>
            ...
            they are primarily oral. Extinct and historical languages often have harder-to-find writing system
            information. Sign languages are excluded from this report.
                        ...
                        return (
                            <ViewCard key={lang.ID}>
                                ...
                                <div>
                                    ...
                                    {family ? <HoverableObjectName object={family} /> : <Deemphasized>None</Deemphasized>}
                                </div>
                                <div>
