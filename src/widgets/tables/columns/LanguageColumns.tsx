...
function getLanguageColumns(): TableColumn<LanguageData>[] {
  return [
    ...
    },
    {
      ...
      description: (
        <>
          The writing systems used to write this language. The possible values come from ISO 15924,
          which include some combined systems like <code>Hani</code> including all Chinese
...
export default getLanguageColumns;
