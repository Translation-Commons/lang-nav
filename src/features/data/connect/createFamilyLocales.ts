  ...
  childLocales.forEach((childLocale) => {
    ...
    if (newLocale == null) {
      ...
      newLocale = {
        ...
        localesWithinThisLanguage: [childLocale], // Keep track of the original locales that were aggregated
      };
      ...
      if (
        ...
        newLocale.localesWithinThisLanguage = [
          ...(newLocale.localesWithinThisLanguage || []),
          childLocale,
        ];
    ...
    // Link the child locale to its new parent locale
    childLocale.localeForParentLanguage = newLocale;
  });
